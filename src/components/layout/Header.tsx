...
export default function Header() {
    ...
    return (
        <header className='fixed top-0 left-0 h-16 bg-slate-950 z-50 w-full'>
            ...
            <nav
                className={`fixed top-16 z-50 h-[calc(100%-4rem)] flex flex-col items-center justify-center w-full bg-slate-950 -translate-x-[101%] transition-transform duration-300 md:flex-row  md:h-16 md:top-0 md:border-0 md:translate-x-0 md:transition-none ${
